...
import br.com.amedigital.banner.CategoriaContract
import br.com.amedigital.banner.CategoriaPresenter
...
class MainActivityTest {
    ...
    @Mock
    lateinit var viewCategory: CategoriaContract.View
    @Mock
    ...
    lateinit var bannerPresenter: BannerPresenter
    lateinit var categoriaPresenter: CategoriaPresenter
    ...
    fun setUp() {
        ...
        categoriaPresenter = CategoriaPresenter(callCategory, viewCategory)
    ...
    fun showCategories() {
        ...
        callbackArgumentCaptorCategory?.apply {
            categoriaPresenter.loadCategories()
