...
class MainActivity : AppCompatActivity(), BannerContract.View,
    ...
    private fun loadCategories() {
        val call = LojinhaServiceEndPoint().getCategoria()
        val presenter = CategoriaPresenter(call, this)
        presenter.loadCategories()
    }

    private fun loadProductsMoreSales() {
        val call = LojinhaServiceEndPoint().getProdutosMaisVendidos()
